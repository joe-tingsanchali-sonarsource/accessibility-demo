...
export const TableCellsWrongHeaders = () => (
  <table>
    <caption>TypeScript Employee Directory</caption>
    <thead>
      <tr>
        <th id="ts-col-name">Name</th>
        <th id="ts-col-age">Age</th>
        <th id="ts-col-city">City</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        {/* headers attribute points to non-existent IDs */}
        <td headers="ts-col-country ts-col-unknown">Alice</td>
        <td headers="ts-col-zip ts-col-unknown">28</td>
        <td headers="ts-col-region ts-col-unknown">Engineering</td>
      </tr>
    </tbody>
  </table>
);
